export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Privacy Policy for AlivnBOT</h1>
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <div className="py-3"></div>
        <p>⊳ You cannot use certain commands at the same time while using AlivnBOT.</p>   
        <div className="py-3"></div>
        <p>⊳ AlivnBOT bot does not save any data based on users.</p>
        <div className="py-3"></div>
